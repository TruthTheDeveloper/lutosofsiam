  ...
  return (
    <div className="lg:h-[30rem] ">
      <div className="text-center  mt-12">
        ...
        <p className="md:text-lg text-sm py-2">
          {" "}
          Uncover the Freshest Updates and Insights
        </p>
      </div>
      ...
      <div className="md:flex justify-between mt-8 ">
        <div className="mx-auto lg:flex">
          ...
          <div
            ...
            data-aos-once
          >
            <h2 className="my-4 bg-yellow-300 font-bold text-center w-48  py-2 rounded-md mt-8">
        ...
        <div className="mx-auto md:px-2 px-10 lg:flex mt-24 md:mt-0 lg:mt-0">
          ...
          <div
            ...
            data-aos-once
          >
            <h2 className="my-4 bg-yellow-300 font-bold w-48 text-center  py-2 rounded-md mt-8">
              29th of december, 2023
            </h2>
            <p className="font-semibold text-xl ">
              Sahara location is temporarily CLOSED, Now accepting walk-in
              reservations.
            </p>
          </div>
        </div>
