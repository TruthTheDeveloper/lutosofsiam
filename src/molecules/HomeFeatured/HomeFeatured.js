      ...
      <div className="md:flex justify-between   w-[100%] lg:w-[70%] mx-auto pt-10  ">
          ...
          <>
            ...
            initial={{scale:1}}
              ...
              transition={{ duration: 0.3 }} className="bg-green-600 text-white py-2  px-4 rounded-2xl ">
                    Order online
                  </motion.button>
                </div>
              </div>
            ...
            <div
              ref={ref}
              className=" bg-white h-[18rem] w-[17rem] mx-auto rounded-[3rem] border shadow-lg my-24 md:my-0 "
              initial={{ x: -300, y: 0, opacity: 0, scale: 0.5 }}
              data-aos="zoom-in"
              data-aos-duration="900"
              data-aos-once
              animate={
                inView ? { x: 45, y: 0, opacity: 1, scale: 1, rotate: 360 } : {}
              }
              transition={{ duration: 1.5 }}
            >
              <Image
